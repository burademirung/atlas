...
variable "eks_public_access_cidrs" {
  description = "CIDR allow-list for the public EKS API endpoint. Default [] keeps the endpoint private-only; set your admin/VPN egress CIDRs to opt in. Must not be 0.0.0.0/0."
  type        = list(string)
  default     = []
}
